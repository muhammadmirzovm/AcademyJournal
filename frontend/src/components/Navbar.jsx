...
import { Sun, Moon, Menu, X, GraduationCap, LogOut, User, LayoutDashboard, Users, Globe, BookMarked, Settings, Gift, PiggyBank, ScanLine } from 'lucide-react'
...
export default function Navbar() {
  ...
  const navLinks = user ? [
    ...
    ...(user.role === 'admin'
      ? [
          { to: '/scanner', label: t('nav.scanner'), icon: <ScanLine size={15} /> },
