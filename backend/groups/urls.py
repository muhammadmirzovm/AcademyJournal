...
from .views import (
    ...
    GroupGraduateView, GroupStatusView, GroupExamReadyView, ExamListCreateView, ExamDetailView, ExamSubmitView,
...
urlpatterns = [
    ...
    path('groups/<int:group_pk>/status/',                                        GroupStatusView.as_view(),          name='group_status'),
