...
from .views import (
    ...
    GameSwapMembersView, GameReshuffleView,
)
...
urlpatterns = [
    ...
    path('groups/<int:group_pk>/games/<int:game_pk>/swap/',        GameSwapMembersView.as_view()),
    path('groups/<int:group_pk>/games/<int:game_pk>/reshuffle/',   GameReshuffleView.as_view()),
]
